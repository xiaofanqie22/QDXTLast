...
#define setBoldFont(size)[PublicFun setFont:size IsBold:YES]
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.color = nil;
        self.labelFont = setBoldFont(kLabelFontSize);// [UIFont boldSystemFontOfSize:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
        self.detailsLabelFont = setBoldFont(kDetailsLabelFontSize);//[UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
