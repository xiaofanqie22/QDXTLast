...
- (ARSCNView *)arLeftView  API_AVAILABLE(ios(11.0)){
    ...
    if (!_arLeftView) {
        ...
        _arLeftView = [[ARSCNView alloc] initWithFrame:CGRectMake(0, 0, Screen_Width, 0.5 * Screen_Height)];
...
- (ARSCNView *)arRightView  API_AVAILABLE(ios(11.0)){
    ...
    if (!_arRightView) {
        _arRightView = [[ARSCNView alloc] initWithFrame:CGRectMake(
           0,
           (!_isCardBoard ? 0 : 0.5) * Screen_Height,
           Screen_Width,
           (!_isCardBoard ? 1.0 : 0.5) * Screen_Height)];
